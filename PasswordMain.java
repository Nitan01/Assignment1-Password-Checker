...
*/
	public void checkPassword() {
	    ...
	    String passwordAString = passwordAText.getText();
	    try {
	        // Use comparePasswords, not comparePasswordsWithReturn, to throw the exception
	        ...
	        // This message will now display properly when passwords don't match
	...
	public void readFile() {
	    ...
	    if (selectedFile != null) {
	        ...
	        try {
	            ...
	            // Add invalid passwords to the results
	            for (String passwordString : invalidPassword)
	                results += passwordString + "\n";

	            // Show the results using an Alert dialog
	        ...
	        // If no file was selected, show an alert
	        alert.setTitle("No File Selected");
	        alert.setHeaderText(null);
	        alert.setContentText("No file was selected. Please choose a file to check passwords.");
	        alert.showAndWait();
	    }
	}
	}
